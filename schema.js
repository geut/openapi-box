...
const cache = {}
cache['20c72cefd4115c5920c89a5193a743ac'] = T.Any()
...
cache['8a0e72bd020a90249508a3d6f36a7983'] = {
  ...
  name: T.String(),
  parameters: T.Optional(Json({ additionalProperties: true }))
}
...
cache['533ef2a989ee66dde5feefb7207aadef'] = {
  messages: T.Array(cache['20c72cefd4115c5920c89a5193a743ac'], { minItems: 1 }),
  ...
  logit_bias: T.Optional(
    Json({ default: null, additionalProperties: { type: 'integer' } })
  ),
  ...
  stream_options: T.Optional(
    T.Object(cache['35aebd667abc35dedb7a3bb43497761e'], { default: null })
  ),
...
cache['2a0d563490dcb656be5c27a37522d189'] = Json({
...
cache['8a3123f5f76b0f17e6dd45dd2963d769'] = {
  batch_size: T.Any(),
  learning_rate_multiplier: T.Any(),
  n_epochs: T.Any()
}
...
cache['c4721d3b9d9fe2c665e72b80c8274641'] = T.Any()
...
cache['1a940c74617f188b00495cc5646b35c3'] = T.Any()
...
cache['e4fcdbc97059dd13fbdd9af6b0596815'] = {
  file_ids: T.Optional(
    T.Array(cache['2809284b6e54d0d34017715ffe5636bd'], { maxItems: 10000 })
  ),
...
cache['478f2248a8d1afbac14c83f27aa737b0'] = T.Object(
  cache['e4fcdbc97059dd13fbdd9af6b0596815']
)
cache['0fabae221780a23691a4bac9d8e41ad6'] = {
  vector_store_ids: T.Optional(
    T.Array(cache['2809284b6e54d0d34017715ffe5636bd'], { maxItems: 1 })
  ),
  vector_stores: T.Optional(
    T.Array(cache['478f2248a8d1afbac14c83f27aa737b0'], { maxItems: 1 })
  )
}
cache['4044533822793c67d69dc65af3a9f770'] = {
  ...
  file_search: T.Optional(
    T.Object(cache['0fabae221780a23691a4bac9d8e41ad6'], {
      oneOf: [
...
cache['b630310d6509c394b7780963684a46f2'] = T.Any()
...
cache['76f4fd16d972dea0b736e091df7d7d8a'] = T.Object(
  cache['e4fcdbc97059dd13fbdd9af6b0596815']
)
cache['5c0235548e6b10c471dd2a5c9f8b9f4e'] = {
  vector_store_ids: T.Optional(
    T.Array(cache['2809284b6e54d0d34017715ffe5636bd'], { maxItems: 1 })
  ),
  vector_stores: T.Optional(
    T.Array(cache['76f4fd16d972dea0b736e091df7d7d8a'], { maxItems: 1 })
  )
}
cache['4b8355c7a5062583c425a4a3a164eb53'] = {
  ...
  file_search: T.Optional(
    T.Object(cache['5c0235548e6b10c471dd2a5c9f8b9f4e'], {
      oneOf: [
        { required: ['vector_store_ids'] },
        { required: ['vector_stores'] }
      ]
...
cache['8bd4ecb40e2fe58622f63200040f870f'] = T.Any()
...
cache['9851d512f6dcdc5167bb2cd5a8d2253d'] = T.Any()
...
cache['36d0e17dc9401aaf7fedb03cb865e3b0'] = {
  ...
  metadata: T.Optional(Json({ additionalProperties: { type: 'string' } }))
}
...
cache['7edd3994414548b4a3436df93b2a8fb4'] = {
  content: T.Any(),
...
cache['c0ef8282ef155ca92cb2d4fb93640a88'] = T.Any()
cache['7af5e4ab950a3ef6eddaf9254506e227'] = {
  messages: T.Optional(
    T.Array(cache['c0ef8282ef155ca92cb2d4fb93640a88'], { minItems: 1 })
  ),
  tools: T.Optional(T.Array(cache['69c83e993b83a184c6641fcad3e2fa79'])),
  parallel_tool_calls: T.Optional(T.Boolean({ default: true })),
  functions: T.Optional(
...
cache['fc41dc638547d233500551b618f6cf9f'] = T.Any()
...
cache['8d1c447e0cb817cb5dae36a1bd9534b8'] = T.Any()
...
cache['4c2225e32aff9ad377bc554bb8395659'] = T.Any()
...
cache['d66db088d4466dc3406c1ccf975823db'] = T.Any()
  ...
  oneOf: [
    {
      ...
      description:
        'Text output from the Code Interpreter tool call as part of a run step.',
      properties: {
        type: { description: 'Always `logs`.', type: 'string', enum: ['logs'] },
        logs: {
          type: 'string',
...
cache['14c2341711858bb7a6cb0d8004c993c5'] = Json({
  oneOf: [
    {
      title: 'Code interpreter log output',
      type: 'object',
...
const schema = {
  '/chat/completions': {
    POST: {
      args: T.Object({
        body: T.Object(cache['533ef2a989ee66dde5feefb7207aadef'], {
...
const _components = {
  schemas: {
    ...
    ChatCompletionRequestMessageContentPart: T.Any(),
    ...
    ChatCompletionRequestMessage: T.Any(),
    ...
    FunctionParameters: Json({ additionalProperties: true }),
    ...
    ChatCompletionToolChoiceOption: T.Any(),
    ...
    CreateChatCompletionImageResponse: Json(),
    ...
    CancelUploadRequest: Json({ additionalProperties: false }),
    ...
    AssistantsApiResponseFormatOption: T.Any(),
    ...
    AssistantsApiToolChoiceOption: T.Any(),
    ...
    ChunkingStrategyRequestParam: Json({
      oneOf: [
        {
          type: 'object',
          title: 'Auto Chunking Strategy',
    ...
    AssistantStreamEvent: T.Any(),
    ThreadStreamEvent: T.Any(),
    RunStreamEvent: T.Any(),
    RunStepStreamEvent: T.Any(),
    MessageStreamEvent: T.Any(),
